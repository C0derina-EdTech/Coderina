...
const WhatBody = () => {
  ...
  return (
    <Box  className="what__container pt-6 md:pt-10 2xl:pt-16 px-2 md:px-4 lg:px-16">
      <Stack>
        <Stack>
          ...
          <Link
            href="/firstlego"
            className="bg-black flex items-center justify-between text-white rounded-3xl px-6 py-3 gap-x-3 text-sm font-medium"
          >
