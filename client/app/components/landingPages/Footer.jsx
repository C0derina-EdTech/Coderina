...
const Footer = () => {
  ...
  // ✅ Default styles (prevents undefined)
let bgColor = "bg-black";
let textColor = "text-white";
let subTextColor = "text-gray-300";
...
if (pathname?.startsWith("/programs") || pathname?.startsWith("/events")) {
  ...
  const skillsLinks = [
    ...
    { label: "Coderina University Challenge (COUCH)", url: "/coderina-university-challenge" },
  ];
            ...
            <div className="flex flex-col items-center text-sm w-full md:w-auto">
              <div className="flex flex-col md:flex-row w-full gap-2">
                ...
                <button
                  ...
                  className={`${buttonBg} ${buttonHoverBg} text-white px-6 py-2.5 rounded-md font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed`}
                >
                  {subscriberSubmitting ? (
