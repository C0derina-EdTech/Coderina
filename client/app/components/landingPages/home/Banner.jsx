...
const Banner = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(
    getTimeRemaining(CHAMPIONSHIP_DATE)
  );
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-20 shadow-lg bg-linear-to-b from-teal-900 via-teal-800 to-teal-900 py-3">
