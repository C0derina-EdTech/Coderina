  ...
  return (
    <>
      ...
      >
        ...
        {/* ─── HERO CONTENT ─── */}
        <div className="relative z-10 flex items-center sm:min-h-[calc(100vh-76px)] px-4 sm:px-6 md:px-8 lg:px-12 2xl:px-16 pb-16 sm:pb-36 pt-4 max-w-[100rem] mx-auto overflow-hidden">
          <div className="max-w-xl xl:max-w-2xl 2xl:max-w-3xl w-full">
            ...
            <h1
              ...
              className="slide-enter text-4xl sm:text-5xl lg:text-5xl 2xl:text-7xl font-normal text-white leading-[1.06] mb-5 sm:mb-6"
              style={{
            ...
            <p
              key={`body-${current}`}
              className="slide-enter text-sm sm:text-[15px] text-white/70 max-w-md xl:max-w-lg leading-relaxed mb-8 sm:mb-10 font-light"
