        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          <div className="max-w-5xl mx-auto mb-12 sm:mb-16">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed text-center">
              ...
              is an innovative platform designed to inspire creativity, foster
              entrepreneurial mindsets, and encourage the practical application
              of academic research among students in tertiary education. By
              bridging the gap between theoretical knowledge and real-world
              application, COUCH empowers students to develop solutions that
              address pressing societal challenges across Nigeria.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
            <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#f9a826] transition-all">
              ...
              <h3 className="font-bold text-gray-900 mb-2 text-xs sm:text-sm md:text-base">
                Target Audience
              </h3>
              <p className="text-xs sm:text-sm text-gray-600">
                Students in tertiary institutions across Nigeria
              </p>
            </div>
            <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#f9a826] transition-all">
            ...
            <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#f9a826] transition-all">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Multi-phase competition with mentorship
              </p>
            </div>
            <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#f9a826] transition-all">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Prizes, mentorship & industry exposure
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#f9a826] to-[#e89516] rounded-2xl p-6 sm:p-8 text-center text-white">
            <p className="text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
              ...
              , COUCH empowers students to transform ideas into impactful
              solutions that drive sustainable national transformation.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-[100rem] mx-auto">
            <div className="text-center mb-10 sm:mb-12 md:mb-16">
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 mt-3 sm:mt-4">
                {currentData.teams.length} innovative teams showcasing
